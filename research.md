...
{% endif %} *{{pub.year}}*  [[web]({% if pub.internal %}{{pub.url | prepend: site.baseurl}}{% else %}{{pub.url}}{% endif %})] {% if pub.doi %}[[doi]({{pub.doi}})]{% endif %} {% if pub.pdf %}[[pdf]({{pub.pdf}})]{% endif %} {% if pub.code %}[[code]({{pub.code}})]{% endif %} {% if pub.presentation %}[[video]({{pub.presentation}})]{% endif %}
